...
CREATE TABLE Post (
    ...
    CONSTRAINT FK_Post_Author FOREIGN KEY(AuthorId) REFERENCES Author(Id) ON DELETE CASCADE,
...
CREATE TABLE AuthorTag (
    ...
    CONSTRAINT FK_AuthorTag_Author FOREIGN KEY(AuthorId) REFERENCES Author(Id) ON DELETE CASCADE,
